      ...
      .when('/SangamForm', {
        ...
        */
        ...
        $translateProvider.translations('0409', {
            ...
            BIHELP: 'This form is used to collect all the basic infomration about this profile which helps in showcasing this profile to the viewrs who are in serach.',
            ...
            CRHELP: 'This form is used to collect infomration about the Education details, Occupation details of this profile',
            CONRF: 'Contact Information Registration Form',
            CONEMAIL: 'Email',
            CONMOBNO: 'Mobile Number',
            CONLNDNO: 'Landline Number',
            CONRESADR: 'Residentail Address',
            CONREL: 'Relationship',
            CONTMETOCALL: 'Time to call',
            CONHELP: 'This form is used to collect infomration about the contact details about this profile',
            ...
            FAMHELP: 'This form is used to collect infomration about the family details of this profile',
            ...
            LOCHLP: 'This form is used to collect infomration about the location information about this profile',
            REFIRF: 'Reference Information Registration Form',
            REFNOMNAME: 'Nominee Name',
            REFCONTNUM: 'Contact Number',
            REFHLP: 'This form is used to collect infomration about the people who are reference for this profile',
            ...
            PHOHLP: 'This form is used to collect infomration about the photo of this profile',
            ...
            SRCIDHLP: 'This form is used to collects profile ID and displays the same',
            SRCGENHLP: 'his form is used to collects profile ID and displays the same',
            SRCSGMSRCH: 'Search by Sangam',
            SRCSGMFLTRBYSGM: 'Filter by Sangam',
            SRCSGMHLP: 'This form is used to collects profile ID and displays the same',
            VWSGMINFOFORPROFID: 'Sangam Information for Profile ID',
            VWRESTXT: 'To view the full infomration of this Profile, you got to register in this Sangam. <br> Please find the Sangam details below to register. Once you registered, you will be able to access the full information.',
