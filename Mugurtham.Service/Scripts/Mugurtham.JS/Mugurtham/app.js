...
(function () {
    ...
    app.config(['$routeProvider', '$translateProvider', '$locationProvider', function ($routeProvider, $translateProvider, $locationProvider) {
        $routeProvider
      ...
      .when('/SangamForm', {
        ...
        */
        ...
        $translateProvider.translations('0409', {
            ...
            FAMFATNAM: "Father's Name",
            FAMMOTNAM: "Mother's Name",
            FAMFATOCC: "Father's Occupation",
            FAMMOTOCC: "Mother's Occupation",
        ...
        $translateProvider.translations('044c', {
            ...
            GENMALE: 'ആൺ',
            GENFEMALE: 'സ്ത്രീ',
            GENPROFID: 'പ്രൊഫൈൽ ഐഡി',
            GENSAVE: 'രക്ഷിക്കും',
            GENCOPYRT: 'പകർപ്പവകാശം',
            GENSANGAM: 'സംഗം',
            GENABOUT: 'കുറിച്ച്',
            LYTSRCH: 'പ്രൊഫൈലുകൾ തിരയുക',
            LYTPROFILES: 'പ്രൊഫൈലുകൾ',
            LYTSHRTLISPROFILES: 'പ്രൊഫൈലുകൾ ഞാൻ ലൈക്ക്',
            LYTEDITMYPROFILE: 'എന്റെ പ്രൊഫൈൽ എഡിറ്റ്',
            LYTSETTINGS: 'ക്രമീകരണങ്ങൾ',
            LYTUSRHOME: 'ഉപയോക്തൃ ഹോം',
            LYTPROFDASHBRD: 'പ്രൊഫൈൽ ഡാഷ്ബോർഡ്',
            LYTPRFREGFOR: 'പ്രൊഫൈൽ രജിസ്ട്രേഷൻ - പ്രൊഫൈൽ ഐഡി വേണ്ടി',
            LYTPRFTABBI: 'അടിസ്ഥാന വിവരങ്ങൾ',
            LYTPRFTABCAR: 'കരിയർ',
            LYTPRFTABCONT: 'ബന്ധപ്പെടുക',
            LYTPRFTABFAM: 'കുടുംബ',
            LYTPRFTABLOC: 'സ്ഥലം',
            LYTPRFTABREF: 'റഫറൻസ്',
            LYTPRFTABHORO: 'ജാതകം',
            LYTPRFTABPHO: 'ഫോട്ടോ',
            BIBINFREGFRM: 'അടിസ്ഥാന വിവരം രജിസ്ട്രേഷൻ ഫോം',
            BISANGAMUSERID: 'സംഘ ഉപയോക്തൃ ഐഡി',
            BINAME: 'പേര്',
            BIAGE: 'പ്രായം',
            BIGEN: 'ലിംഗഭേദം',
            BIDOB: 'ജനിച്ച ദിവസം',
            BITOB: 'ജനനസമയത്തെ',
            BIMARSTATUS: 'വൈവാഹിക നില',
            BINOOFCHIL: 'നോ മക്കളുടെ',
            BICHILLVNGST: 'ജീവിക്കുന്ന കുട്ടികൾക്ക് സ്ഥിതി',
            BIHEIGHT: 'ഉയരം',
            BIWEIGHT: 'ഭാരം',
            BIBDYTPE: 'ശരീരപ്രകൃതി',
            BICOMPLEXION: 'മുഖച്ഛായ',
            BIPHYSTA: 'ശാരീരിക അവസ്ഥ',
            BIBLGRP: 'രക്ത ഗ്രൂപ്പ്',
            BIMOTONG: 'മാതൃ ഭാഷ',
            BIPROFCRBY: 'പ്രൊഫൈൽ സൃഷ്ടിച്ചത്',
            BIRLGN: 'മതം',
            BICST: 'ജാതി',
            BISUBCST: 'അനുപമം',
            BIGOTHRM: 'Gothram ',
            BISTR: 'സ്റ്റാർ',
            BIRAASI: 'Rasi',
            BIHORMTCH: 'ജാതക പൊരുത്തം',
            BIANYDHSM: 'ഏതെങ്കിലും Dosha',
            BIETNG: 'ഭക്ഷണശൈലി',
            BISMKNG: 'പുകവലി',
            BIDRNKNG: 'കുടിവെള്ളം',
            BIABTME: 'എന്നെ പറ്റി',
            BIPRTNTEXPTN: 'പങ്കാളി പ്രതീക്ഷ',
            BIHELP: 'ഈ ഫോം അന്വേഷിച്ചാണ് ആർ കാഴ്ചകൾ ഈ പ്രൊഫൈൽ പ്രദർശിപ്പിക്കും സഹായിക്കുന്നു ഈ പ്രൊഫൈൽ കുറിച്ച് എല്ലാ അടിസ്ഥാന             വിവരങ്ങൾ ശേഖരിക്കാൻ ഉപയോഗിക്കുന്നു.',
            CRIRF: 'കരിയർ വിവരം രജിസ്ട്രേഷൻ ഫോം',
            CREDUC: 'വിദ്യാഭ്യാസം',
            CREDUCDT: 'വിദ്യാഭ്യാസം വിശദമായി',
            CREMPIN: 'ജോലി',
            CROCCPTN: 'തൊഴിൽ',
            CROCCPTNDTL: 'വിശദമായി തൊഴിൽ',
            CRANINC: 'വാർഷിക വരുമാനം',
            CRHELP: 'ഈ ഫോം, വിദ്യാഭ്യാസം വിശദാംശങ്ങൾ വിവരങ്ങൾ ശേഖരിക്കാൻ ഉപയോഗിക്കുന്ന ഈ പ്രൊഫൈലിന്റെ തൊഴിൽ വിശദാംശങ്ങൾ',
            CONRF: 'ബന്ധപ്പെടുക വിവരം രജിസ്ട്രേഷൻ ഫോം',
            CONEMAIL: 'EMAIL',
            CONMOBNO: 'മൊബൈൽ നമ്പർ',
            CONLNDNO: 'ലാൻഡ്ലൈൻ നമ്പർ',
            CONRESADR: 'വാസയോഗ്യമായ വിലാസം',
            CONREL: 'ബന്ധങ്ങളുടെ',
            CONTMETOCALL: 'വിളിക്കാൻ സമയം',
            CONHELP: 'ഈ ഫോം ഈ പ്രൊഫൈൽ കുറിച്ച് കോൺടാക്റ്റ് വിശദാംശങ്ങൾ വിവരങ്ങൾ ശേഖരിക്കാൻ ഉപയോഗിക്കുന്നു',
            FAMIRF: 'കുടുംബ വിവരങ്ങൾ രജിസ്ട്രേഷൻ ഫോം',
            FAMVAL: 'കുടുംബ value',
            FAMTYP: 'കുടുംബ ഇനം',
            FAMSTA: 'കുടുംബ സ്ഥിതി',
            FAMFATNAM: 'അച്ഛന്റെ പേര്',
            FAMMOTNAM: 'അമ്മമാർ പേര്',
            FAMFATOCC: 'പിതാവിന്റെ ജോലി',
            FAMMOTOCC: 'അമ്മയുടെ ജോലി',
            FAMANSFAMORG: 'കുലം / കുടുംബ ഒറിജിൻ',
            FAMNOOFBRO: 'അല്ല ബ്രദേഴ്സ്',
            FAMMARDBRO: 'വിവാഹിത ബ്രദേഴ്സ്',
            FAMNOOFSIS: 'അല്ല സഹോദരിമാർ',
            FAMMARDSIS: 'വിവാഹം',
            FAMABTFAM: 'കുടുംബത്തെ കുറിച്ച്',
            FAMHELP: 'ഈ ഫോം ഈ പ്രൊഫൈലിന്റെ കുടുംബ വിവരങ്ങൾ വിവരങ്ങൾ ശേഖരിക്കാൻ ഉപയോഗിക്കുന്നു',
            LOCIRF: 'സ്ഥലം വിവരം രജിസ്ട്രേഷൻ ഫോം',
            LOCTRYLVNIN: 'രാജ്യം ജീവിക്കുന്നു',
            LOCTNSHP: 'പൗരത്വ',
            LOCRESSTS: 'വാസയോഗ്യമായ സ്റ്റാറ്റസ്',
            LOCRESTATE: 'റെസിഡന്റ് സ്റ്റേറ്റ്',
            LOCRESCTY: 'റസിഡന്റ് സിറ്റി',
            LOCHLP: 'ഈ ഫോം ഈ പ്രൊഫൈൽ കുറിച്ച് ലൊക്കേഷൻ വിവരം വിവരങ്ങൾ ശേഖരിക്കാൻ ഉപയോഗിക്കുന്നു',
            REFIRF: 'റഫറൻസ് വിവരങ്ങൾ രജിസ്ട്രേഷൻ ഫോം',
            REFNOMNAME: 'നോമിനിക്ക് പേര്',
            REFCONTNUM: 'ബന്ധപ്പെടുക നമ്പർ',
            REFHLP: 'ഈ ഫോം ഈ പ്രൊഫൈലിന്റെ റഫറൻസ് ജനങ്ങളില് വിവരങ്ങൾ ശേഖരിക്കാൻ ഉപയോഗിക്കുന്നു',
            HOROIRF: 'ജാതക വിവരം രജിസ്ട്രേഷൻ ഫോം',
            HORSOORIYAN: 'SOORIYAN',
            HORBUDHAN: 'BUDHAN',
            HORGURU: 'ഗുരു',
            HORKETHU: 'GETHU',
            ...
            HORSEVAI: 'SEVAI',
            HORSANI: 'സാനി',
            PHOIRF: 'പ്രൊഫൈൽ ഫോട്ടോ വിവരം രജിസ്ട്രേഷൻ ഫോം',
            PHOHLP: 'ഈ ഫോം ഈ പ്രൊഫൈലിന്റെ പ്രൊഫൈൽ / ആൽബം ഫോട്ടോകൾ അപ്ലോഡ് ഉപയോഗിക്കുന്നു',
            LYTSRCPROFSRC: 'പ്രൊഫൈൽ തിരച്ചില്',
            LYTSRCALLPROF: 'എല്ലാ പ്രൊഫൈലുകൾ',
            LYTGENSRC: 'ജനറൽ തിരച്ചില്',
            LYTSGMSRC: 'സംഗം തിരച്ചില്',
            SRCIDPROFID: 'പ്രൊഫൈൽ ഐഡി പ്രകാരം തിരയുക',
            SRCIDHLP: 'ഈ ഫോം പ്രൊഫൈൽ ഐഡി ശേഖരിക്കാൻ ഉപയോഗിക്കുന്ന പ്രൊഫൈൽ വിവരങ്ങൾ കാണിയ്ക്കുന്നു ആണ്',
            SRCGENHLP: 'ഈ ഫോം പ്രൊഫൈൽ ഐഡി ശേഖരിക്കാൻ ഉപയോഗിക്കുന്ന പ്രൊഫൈൽ വിവരങ്ങൾ കാണിയ്ക്കുന്നു ആണ്',
            SRCSGMSRCH: 'സംഗം തിരയുക',
            SRCSGMFLTRBYSGM: 'സംഗം പ്രകാരം ഫിൽട്ടർ',
            SRCSGMHLP: 'ഈ ഫോം പ്രൊഫൈൽ ഐഡി ശേഖരിക്കാൻ ഉപയോഗിക്കുന്ന പ്രൊഫൈൽ വിവരങ്ങൾ കാണിയ്ക്കുന്നു ആണ്',
            VWSGMINFOFORPROFID: 'പ്രൊഫൈൽ ഐഡി വേണ്ടി സംഗം വിവരം',
            VWRESTXT: 'ഈ പ്രൊഫൈൽ നിറഞ്ഞ വിവരങ്ങൾ കാണുന്നതിന്, നിങ്ങൾ ഈ സംഘ രജിസ്റ്റർ കിട്ടി. ട്രാവൽ സംഗം രജിസ്റ്റർ വിശദാംശങ്ങൾ ചുവടെ കണ്ടെത്താൻ ദയവായി. നിങ്ങൾ രജിസ്റ്റർ ചെയ്താൽ, നിങ്ങൾ പൂർണ്ണ വിവരങ്ങൾ ആക്സസ് കഴിയും. ',
            VWCTADRS: 'ബന്ദപ്പെടാനുള്ള വിലാസം',
            VWABTSGM: 'സംഗം കുറിച്ച്',
            VWFULLPROFVW: 'പ്രൊഫൈൽ ഐഡി വേണ്ടി പൂർണ്ണമായ പ്രൊഫൈൽ കാണുക',
        ...
        $translateProvider.translations('044b', {
            ...
            GENMALE: 'ಪುರುಷ',
            GENFEMALE: 'ಸ್ತ್ರೀ',
            GENPROFID: 'ಪ್ರೊಫೈಲ್ ID',
            GENSAVE: 'ಉಳಿಸಿ',
            GENCOPYRT: 'ಕೃತಿಸ್ವಾಮ್ಯ',
            GENSANGAM: 'ಸಂಗಮ್',
            GENABOUT: 'ಬಗ್ಗೆ',
            LYTSRCH: 'ಪ್ರೊಫೈಲ್ಗಳು ಹುಡುಕಿ',
            LYTPROFILES: 'ಪ್ರೊಫೈಲ್ಗಳು',
            LYTSHRTLISPROFILES: 'ಪ್ರೊಫೈಲ್ಗಳು ನಾನು ಇಷ್ಟಪಟ್ಟ',
            LYTEDITMYPROFILE: 'ನನ್ನ ಪ್ರೊಫೈಲ್ ಸಂಪಾದಿಸಿ',
            LYTSETTINGS: 'ಸೆಟ್ಟಿಂಗ್ಸ್',
            LYTUSRHOME: 'ಬಳಕೆದಾರ ಮುಖಪುಟ',
            LYTPROFDASHBRD: 'ವಿವರ ಡ್ಯಾಶ್ಬೋರ್ಡ್',
            LYTPRFREGFOR: 'ವಿವರ ನೋಂದಣಿ - ಪ್ರೊಫೈಲ್ ID ಫಾರ್',
            LYTPRFTABBI: 'ಮೂಲ ಮಾಹಿತಿ',
            LYTPRFTABCAR: 'ವೃತ್ತಿ',
            LYTPRFTABCONT: 'ಸಂಪರ್ಕ',
            LYTPRFTABFAM: 'ಕುಟುಂಬ',
            LYTPRFTABLOC: 'ತಾಣ',
            LYTPRFTABREF: 'ಉಲ್ಲೇಖ',
            LYTPRFTABHORO: 'ಜಾತಕ',
            LYTPRFTABPHO: 'ಫೋಟೋ',
            BIBINFREGFRM: 'ಮೂಲಭೂತ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್',
            BISANGAMUSERID: 'ಸಂಗಮ್ ಬಳಕೆದಾರ ID',
            BINAME: 'ಹೆಸರು',
            BIAGE: 'ಯುಗ',
            BIGEN: 'ಜೆಂಡರ್ ',
            BIDOB: 'ಹುಟ್ತಿದ ದಿನ',
            BITOB: 'ಟೈಮ್ ಜನ್ಮ',
            BIMARSTATUS: 'ವೈವಾಹಿಕ ಸ್ಥಿತಿ',
            BINOOFCHIL: 'ಇಲ್ಲ ಮಕ್ಕಳ',
            BICHILLVNGST: 'ಮಕ್ಕಳ ಜೀವನ ಸ್ಥಿತಿ',
            BIHEIGHT: 'ಎತ್ತರ',
            BIWEIGHT: 'ತೂಕ',
            BIBDYTPE: 'ದೇಹ ಪ್ರಕಾರ',
            BICOMPLEXION: 'ಮೈಬಣ್ಣ',
            BIPHYSTA: 'ಶಾರೀರಿಕ ಸ್ಥಿತಿ',
            BIBLGRP: 'ರಕ್ತದ ಗುಂಪು',
            BIMOTONG: 'ಮಾತೃ ಭಾಷೆ',
            BIPROFCRBY: 'ಸ್ವವಿವರ ದಾಖಲಿಸಿದವರು',
            BIRLGN: 'ಧರ್ಮ',
            BICST: 'ಜಾತಿ',
            BISUBCST: 'ಉಪಜಾತಿ',
            BIGOTHRM: 'ಗೊಥಮ್)',
            BISTR: 'ಸ್ಟಾರ್',
            BIRAASI: 'ರಾಶಿ',
            BIHORMTCH: 'ಜಾತಕ ಹೊಂದಿಕೆ',
            BIANYDHSM: 'ಯಾವುದೇ ದೋಷದಲ್ಲಿ',
            BIETNG: 'ಪದ್ಧತಿ',
            BISMKNG: 'ಧೂಮಪಾನ',
            BIDRNKNG: 'ಕುಡಿಯುವ',
            BIABTME: 'ನನ್ನ ಬಗ್ಗೆ',
            BIPRTNTEXPTN: 'ಸಂಗಾತಿ ನಿರೀಕ್ಷೆ',
            BIHELP: 'ಈ ರೂಪ ಹುಡುಕಾಟ ಯಾರು ವೀಕ್ಷಣೆಗಳು ಈ ಪ್ರೊಫೈಲ್ ಪ್ರದರ್ಶಿಸುವ ಸಹಾಯ ಮಾಡುವ ಈ ಪ್ರೊಫೈಲ್ ಬಗ್ಗೆ ಎಲ್ಲಾ ಮೂಲಭೂತ ಮಾಹಿತಿಯನ್ನು ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ.',
            CRIRF: 'ವೃತ್ತಿ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್',
            CREDUC: 'ಶಿಕ್ಷಣ',
            CREDUCDT: 'ಶಿಕ್ಷಣ ವಿವರ',
            CREMPIN: 'ಉದ್ಯೋಗದಲ್ಲಿರುವುದು',
            CROCCPTN: 'ಉದ್ಯೋಗ',
            CROCCPTNDTL: 'ಉದ್ಯೋಗದ ವಿವರ',
            CRANINC: 'ವಾರ್ಷಿಕ ಆದಾಯ',
            CRHELP: 'ಈ ರೂಪ ಶಿಕ್ಷಣ ವಿವರಗಳು, ಈ ಪ್ರೊಫೈಲ್ ಉದ್ಯೋಗ ಬಗ್ಗೆ ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ',
            CONRF: 'ಸಂಪರ್ಕ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್',
            CONEMAIL: 'ಇಮೇಲ್',
            CONMOBNO: 'ಮೊಬೈಲ್ ನಂಬರ',
            CONLNDNO: 'ಸ್ಥಿರ ದೂರವಾಣಿ ಸಂಖ್ಯೆ',
            CONRESADR: 'ಮನೆಯ ವಿಳಾಸ, ವಾಸಸ್ಥಳದ ವಿಳಾಸ',
            CONREL: 'ಸಂಬಂಧ',
            CONTMETOCALL: 'ಟೈಮ್ ಕರೆ',
            CONHELP: 'ಈ ರೂಪ ಈ ಪ್ರೊಫೈಲ್ ಬಗ್ಗೆ ಸಂಪರ್ಕ ವಿವರಗಳು ಬಗ್ಗೆ ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ',
            FAMIRF: 'ಈ ರೂಪ ಈ ಪ್ರೊಫೈಲ್ ಬಗ್ಗೆ ಸಂಪರ್ಕ ವಿವರಗಳು ಬಗ್ಗೆ ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ',
            FAMVAL: 'ಕುಟುಂಬ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್',
            FAMTYP: 'ಕುಟುಂಬ ಕೌಟುಂಬಿಕತೆ',
            FAMSTA: 'ಕೌಟುಂಬಿಕ ಸ್ಥಿತಿ',
            FAMFATNAM: 'ತಂದೆಯ ಹೆಸರು',
            FAMMOTNAM: 'ಮದರ್ಸ್ ಹೆಸರು',
            FAMFATOCC: 'ತಂದೆಯ ಉದ್ಯೋಗ',
            FAMMOTOCC: 'ತಾಯಿಯ ಉದ್ಯೋಗ',
            FAMANSFAMORG: 'ಮನೆತನ / ಕುಟುಂಬ ಮೂಲ',
            FAMNOOFBRO: 'ಬ್ರದರ್ಸ್ ಇಲ್ಲ',
            FAMMARDBRO: 'ವಿವಾಹಿತರು ಸಹೋದರರ',
            FAMNOOFSIS: 'ಸಿಸ್ಟರ್ಸ್ ಇಲ್ಲ',
            FAMMARDSIS: 'ವಿವಾಹಿತರು ಸಿಸ್ಟರ್ಸ್',
            FAMABTFAM: 'ಕುಟುಂಬದ ಬಗ್ಗೆ',
            FAMHELP: 'ಈ ರೂಪ ಈ ಪ್ರೊಫೈಲ್ ಕುಟುಂಬ ವಿವರಗಳು ಬಗ್ಗೆ ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ',
            LOCIRF: 'ಸ್ಥಳ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್',
            LOCTRYLVNIN: 'ದೇಶ ರಲ್ಲಿ',
            LOCTNSHP: 'ನಾಗರಿಕತ್ವ',
            LOCRESSTS: 'ವಸತಿ ಸ್ಥಿತಿಯ',
            LOCRESTATE: 'ನಿವಾಸ ರಾಜ್ಯ ',
            LOCRESCTY: 'ನಿವಾಸ ಸಿಟಿ ',
            LOCHLP: ' ಈ ರೂಪ ಈ ಪ್ರೊಫೈಲ್ ಬಗ್ಗೆ ಸ್ಥಳ ಮಾಹಿತಿಯ ಬಗೆಗಿನ ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ ',
            REFIRF: 'ಹೋಲಿಕೆಯ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್',
            REFNOMNAME: 'ನಾಮಿನಿ ಹೆಸರು',
            REFCONTNUM: 'ಸಂಪರ್ಕ ಸಂಖ್ಯೆ',
            REFHLP: 'ಈ ರೂಪ ಈ ಪ್ರೊಫೈಲ್ ಉಲ್ಲೇಖ ಜನರಿಗೆ ಬಗ್ಗೆ ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ',
            HOROIRF: 'ಜಾತಕ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್',
            HORSOORIYAN: 'SOORIYAN',
            HORBUDHAN: 'BUDHAN',
            HORGURU: 'ಗುರು',
            HORKETHU: 'GETHU',
            ...
            HORSEVAI: ' SEVAI ',
            HORSANI: ' ಶನಿ ',
            PHOIRF: ' ಪ್ರೊಫೈಲ್ ಫೋಟೋ ಮಾಹಿತಿ ನೋಂದಣಿ ಫಾರ್ಮ್ ',
            PHOHLP: ' ಈ ರೂಪ ಪ್ರೊಫೈಲ್ನಲ್ಲಿ ಈ ಪ್ರೊಫೈಲ್ / ಆಲ್ಬಮ್ ಫೋಟೋಗಳನ್ನು ಅಪ್ಲೋಡ್ ಬಳಸಲಾಗುತ್ತದೆ',
            LYTSRCPROFSRC: ' ವಿವರ ಹುಡುಕಾಟ ',
            LYTSRCALLPROF: ' ಎಲ್ಲಾ ಪ್ರೊಫೈಲ್ಗಳು ',
            LYTGENSRC: ' ಸಾಮಾನ್ಯ ಹುಡುಕಾಟ ',
            LYTSGMSRC: ' ಸಂಗಮ್ ಹುಡುಕು ',
            SRCIDPROFID: ' ಪ್ರೊಫೈಲ್ ID ಹುಡುಕಿ ',
            SRCIDHLP: ' ಈ ರೂಪ ಪ್ರೊಫೈಲ್ ID ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ ಮತ್ತು ಪ್ರೊಫೈಲ್ ಮಾಹಿತಿ ಪ್ರದರ್ಶನವಿದೆ',
            SRCGENHLP: ' ಈ ರೂಪ ಪ್ರೊಫೈಲ್ ID ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ ಮತ್ತು ಪ್ರೊಫೈಲ್ ಮಾಹಿತಿ ಪ್ರದರ್ಶನವಿದೆ',
            SRCSGMSRCH: 'ಸಂಗಮ್ ಹುಡುಕಿ ',
            SRCSGMFLTRBYSGM: ' ಸಂಗಮ್ ಮೂಲಕ ಫಿಲ್ಟರ್ ',
            SRCSGMHLP: ' ಈ ರೂಪ ಪ್ರೊಫೈಲ್ ID ಸಂಗ್ರಹಿಸಲು ಬಳಸಲಾಗುತ್ತದೆ ಮತ್ತು ಪ್ರೊಫೈಲ್ ಮಾಹಿತಿ ಪ್ರದರ್ಶನವಿದೆ',
            VWSGMINFOFORPROFID: ' ಪ್ರೊಫೈಲ್ ID ಫಾರ್ ಸಂಗಮ ಮಾಹಿತಿ ',
            VWRESTXT: ' ಈ ಪ್ರೊಫೈಲ್ ಸಂಪೂರ್ಣ ಮಾಹಿತಿಯನ್ನು ವೀಕ್ಷಿಸಲು, ನೀವು ಈ ಸಂಗಮ ನೊಂದಣಿ ಸಿಕ್ಕಿತು. <br> ದಯವಿಟ್ಟು ನೊಂದಣಿ ಕೆಳಗೆ ಸಂಗಮ್ ವಿವರಗಳು ಹೇಗೆ. ನೀವು ನೋಂದಣಿ ಒಮ್ಮೆ ಪೂರ್ಣ ಮಾಹಿತಿ ಪ್ರವೇಶಿಸಲು ಸಾಧ್ಯವಾಗುತ್ತದೆ. ',
            VWCTADRS: ' ಸಂಪರ್ಕ ವಿಳಾಸ',
            VWABTSGM: ' ಸಂಗಮ್ ಬಗ್ಗೆ ',
            VWFULLPROFVW: ' ಪ್ರೊಫೈಲ್ ID ಸಂಪೂರ್ಣ ಪ್ರೊಫೈಲ್ ವೀಕ್ಷಿಸಿ ',
